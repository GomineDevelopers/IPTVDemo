LDAvis = function (to_select, json_file) {
    ...
    d3.json(json_file, function (error, data) {
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            lambdaZero.setAttribute("style", "padding: 5px; height: 20px; width: 220px; font-family: sans-serif; float: left;position: relative;");
        ...
        function topic_on(circle) {
            ...
            d3.select("#bar-freqs")
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("主题" + topics + "的前" + R + "个相关短语" + " (" + Freq + "% of tokens)");
